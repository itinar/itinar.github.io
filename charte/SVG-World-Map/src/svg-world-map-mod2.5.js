...
var svgWorldMap = (function() { 
    ...
    // Global variables
    var svg = document.getElementById("../src/svg-world-map");
    var baseNode;
    var infoBox;
    var isMobile = false;
    ...
    function initMap() {
        ...
        if (document.getElementById('svg-world-map-container') == null) {
            ...
            svg.setAttribute("data", options.libPath + "world-states-provinces-stripes-test05.svg");
            ...
            svg = document.getElementById("../src/svg-world-map");
        }
