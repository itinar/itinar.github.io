...
var svgWorldMap = (function() { 
    ...
    function initMapControls() {
        for (var country in countries) {
            ...
            //countries[country].addEventListener("mouseover", function() { provinceOverOut(this, 'over'); });
            //countries[country].addEventListener("mouseout", function() { provinceOverOut(this, 'out'); });
            //countries[country].addEventListener("mouseup", function() { provinceClick(this); });
            // Add event listeners
            //console.log("countries[country]");console.log(countries[country]);
            for (var i = c.children.length; i > 0; i--) {
                console.log("i: " + i);
                c.children[i-1].addEventListener("mouseover", function() { provinceOverOut(this, 'over'); });
                c.children[i-1].addEventListener("mouseout", function() { provinceOverOut(this, 'out'); });
                c.children[i-1].addEventListener("mouseup", function() { provinceClick(this); });
    ...
    function provinceOverOut(id, overout) {
        document.getElementById("countries").innerHTML = id;
        console.log("id1");console.log(id);
        //document.getElementById("countries").innerHTML = "nnn";
    ...
    function provinceClick(id) {
        document.getElementById("countries").innerHTML = id;
        console.log("id2");console.log(id);
